...
pub fn Logo() -> Element {
    rsx! {
        div {
            ...
            a {
                href: "http://mayiwen.com", // Replace with your actual URL
            ...
            margin: auto",
                ...
                {items.iter().map(|link| {
                    ...
                    rsx! {
                        myw::Button {
                            key: "{link.id}",
                            onclick: move |_| myw::util::window_open(&src),
                            "{link.title}"
                        }
                    }
                })}
...
pub fn Search() -> Element {
    ...
    rsx! {
        div {
            style: "width: 100%; text-align: center;",
            div {
                style: "margin: auto; max-width: 600px; width: 100%; position: relative;",
                //   position: relative;
                input {
                    r#type: "text",
                    value: {text},
                    class: "myw-input",
                    style: " height: 34px;max-width: 600px; width: 100%; padding-right: 60px;",
                    placeholder: "请输入搜索的内容，键入Enter执行搜索",
